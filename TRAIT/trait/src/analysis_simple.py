...
def main():
    args = get_args()
    data = json.load(open(f"../inference_reasoning/prompt_type_{args.prompt_type}/results_reasoning_{args.model_name}.json"))
...
# Usage: python analysis_simple.py --model_name gpt4o --prompt_type 1