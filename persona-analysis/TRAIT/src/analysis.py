...
def main():
    args = get_args()
    data=json.load(open(f"/home/manasm/project_root/TRAIT/inference_likelihood/prompt_type_{args.prompt_type}/results_option_{args.model_name}.json"))
    ...
    txt_path = f"/home/manasm/project_root/TRAIT/results/{args.model_name}.txt"
    with open(txt_path, "w") as f:
        for personality, score in zip(personality_arr, score_arr):
            f.write(f"{personality}:{score}\n")
