...
def main():
    ...
    parser.add_argument('--model', type=str, required=True, help='Model name for labeling the charts')
    ...
    # Save Big Five chart
    fig1.savefig(f'big_5_{args.model}.png', dpi=300, bbox_inches='tight')
    ...
    fig2.savefig(f'sd_3_{args.model}.png', dpi=300, bbox_inches='tight')
