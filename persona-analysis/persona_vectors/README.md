...
# Positive system prompt evaluation -> modified
CUDA_VISIBLE_DEVICES=2 python -m eval.eval_persona \
    --model /scratch/manas/Qwen2.5-7B-Instruct/ \
    --trait psychopathy \
    --output_path eval_persona_extract/Qwen2.5-7B-Instruct/psychopathy_pos_instruct.csv \
    --persona_instruction_type pos \
    --assistant_name psychopathic \
    --judge_model /scratch/manas/Qwen2.5-7B-Instruct/ \
    --version extract
...
CUDA_VISIBLE_DEVICES=2 python -m eval.eval_persona \
    --model /scratch/manas/Qwen2.5-7B-Instruct/ \
    --trait psychopathy \
    --output_path eval_persona_extract/Qwen2.5-7B-Instruct/psychopathy_neg_instruct.csv \
    --persona_instruction_type neg \
    --assistant_name helpful \
    --judge_model /scratch/manas/Qwen2.5-7B-Instruct/  \
    --version extract
...
python generate_vec.py \
    --model_name /scratch/manas/Qwen2.5-7B-Instruct \
    --pos_path eval_persona_extract/Qwen2.5-7B-Instruct/psychopathy_pos_instruct.csv \
    --neg_path eval_persona_extract/Qwen2.5-7B-Instruct/psychopathy_neg_instruct.csv \
    --trait psychopathy \
